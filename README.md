  ...
  ## FEATURES:
  All dialer features (hold by me, direct my call...)
  Google photos unlimited storage
  Pixel 9 pro xl (komodo) spoof (by default only photos app and dialer app. for more apps edit spoof.conf)
  A huge flag list ( i dont rember all :) )
